       ...
       <h3 style="margin-top: -55px;background-color: grey;"><img src="avatar.jpg" style="width: 50px;height: 50px;border: 3px solid transparent; border-radius: 50px"> Status:<?php echo $_SESSION['Username'];  ?> is Active</div></h3>
        <div id="nav">
          <ul style="list-style: none;">
            <li><a class="btn btn-lg btn-success" href="logout.php" role="button">Log out</a> &nbsp <a class="btn btn-lg btn-success" href="admin.php" role="button">Home</a></li>
          </ul>
...
$sql="select * from seats where Status='occupied'";
...
?>
	<tr>
		...
		<td><button name="cancel" onclick="window.confirm('Do you want to Cancel this booked seat?')" type='submit'><img src="cancel.png" width="80" height="80"></button></td>
	</form>
	</tr>
<?php
}
if(isset($_POST['cancel']))
{
	...
	if($query1)
	{
		...
		header("location:AllbookedSeats.php");
	}
}
?>
